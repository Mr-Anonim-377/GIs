...
var TEXT = ['Данная программа была создана для получения зачета по дисциплине Открытые Системы', 'Чтобы воспоьзоваться програмой, нужно иметь учетную запись в системе Argis', 'В данной приложении сосредаточены главные обьекты тимирязевской академии, все, что пользователи данного приложения посчитали нужным', 'Приятного использования'];
var i = 0;
